...
export const colorSchemes = {
	dark: {
		palette: {
			...
			neutral: { ...nevada },
			primary: {
				light: "#135436", // Brighter green hover
				main: "#0d3b26", // Your forest green
				dark: "#072216", // Darker active state
				contrastText: "var(--mui-palette-common-white)", // Fixed to white text for readability
			},
			secondary: {
				...nevada,
				light: nevada[100],
