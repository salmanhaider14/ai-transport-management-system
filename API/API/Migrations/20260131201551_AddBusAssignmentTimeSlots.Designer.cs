...
namespace API.Migrations
{
    ...
    [Migration("20260131201551_AddBusAssignmentTimeSlots")]
    partial class AddBusAssignmentTimeSlots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Features.Entities.DriverAttendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DriverProfileId", "Date")
                        .IsUnique();
            ...
            modelBuilder.Entity("API.Features.Entities.LocationUpdate", b =>
                {
                    ...
                    b.Property<int?>("BusAssignmentId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API.Features.Entities.LocationUpdate", b =>
                {
                    ...
                    b.HasOne("API.Features.Entities.BusAssignment", null)
                        .WithMany("LocationUpdates")
                        .HasForeignKey("BusAssignmentId1");
